...
# aliases to automatically detect countries in the English text and assign ISO3
# country codes.
#
# Articles that cannot be classified automatically are exported for manual
# country labeling and re-imported afterwards. Automatic and manual labels are
# then combined into a final country variable.
#
